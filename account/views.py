...
from core.ml_model import predict_anomaly
...
def dashboard(request):
    if request.user.is_authenticated:
        ...
        recent_recieved_transfer = Transaction.objects.filter(receiver=request.user, transaction_type="transfer").order_by("-id")[:1]
