...
class Transaction(models.Model):
    transaction_id = ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefgh1234567890")
    sender = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="transactions_sent")
    reciever = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="transactions_received")
    ...
    def __str__(self):
        return f"{self.transaction_type} | {self.sender} -> {self.reciever} | {self.amount}"
